...
%         ObjVal(i,1)=pso_pro_objfunc(particle(i, :)); % degerlerin alt alta gorunmesi icin (i,1) yaptik
    ...
    display(['Iter:', num2str(iter), '  Obj:', num2str(gbest_obj)]);
%     ,...
%         '  GSYH:', num2str(gbest_pos(1)), '  Nüfus:', num2str(gbest_pos(2))...
%         '  Ýthalat:', num2str(gbest_pos(3)), '  Ýhracat:', num2str(gbest_pos(4)), '  E sabiti:', num2str(gbest_pos(5))]);
